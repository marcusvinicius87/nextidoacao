...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { codigo_area: @telefone.codigo_area, numero: @telefone.numero, tipo: @telefone.tipo } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { codigo_area: @telefone.codigo_area, numero: @telefone.numero, tipo: @telefone.tipo } }
