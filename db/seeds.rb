...
usuario_teste = User.create!(email: "teste@teste.com", login: "teste", password: '123456', password_confirmation: '123456', instituicao_id: instituicao_teste.id, ativo: false, admin: true)